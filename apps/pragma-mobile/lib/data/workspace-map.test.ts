...
describe("worktreeLabel", () => {
  it("prefers the title, falls back to the branch", () => {
    expect(worktreeLabel(worktree({ title: "Nice" }))).toBe("Nice");
    expect(worktreeLabel(worktree({ title: null, branch: "b" }))).toBe("b");
  });
});
