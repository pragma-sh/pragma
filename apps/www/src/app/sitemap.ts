...
import { compareRoute, docsRoute, downloadsRoute, pluginsRoute, siteUrl } from "@/lib/shared";
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes = ["/", downloadsRoute, pluginsRoute, compareRoute, docsRoute];
