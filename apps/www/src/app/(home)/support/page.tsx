...
/** Masthead: who support covers, and what a reply looks like. */
...
/** The three self-serve destinations, offered before the form. */
    ...
    <section aria-labelledby="self-serve" className="border-border border-t px-6 py-16">
      <div className="mx-auto w-full max-w-6xl">
        ...
        <p className="text-muted-foreground mt-4 max-w-2xl text-sm leading-6">
          Most questions are already answered in one of these three places, and they are faster than
          waiting on us.
        </p>
...
/** The form itself, alongside what we commit to when you use it. */
      ...
      <div className="mx-auto grid w-full max-w-6xl gap-12 lg:grid-cols-[2fr_3fr]">
        <div>
          ...
          <p className="text-muted-foreground mt-4 text-sm leading-6">
            Every field marked optional can be left blank. The more precisely you can describe what
            you expected and what happened instead, the fewer rounds it takes.
          </p>
...
/** What App Review looks for: what we hold, and how to be rid of it. */
      ...
      <div className="mx-auto grid w-full max-w-6xl gap-10 md:grid-cols-3">
        ...
        <div className="text-sm leading-6 md:col-span-2">
          ...
          <p className="text-muted-foreground mt-2">
            ...
            on machines you control, and Pragma Go talks only to the copy of {appName} you paired it
            with. Unpairing removes the stored connection details from the device and revokes it on
            the desktop.
          </p>
          <h3 className="mt-6 font-medium">What a support request leaves behind</h3>
          <p className="text-muted-foreground mt-2">
            The message you send here is delivered to our support inbox and kept only as long as it
            takes to resolve your request. Ask us to delete it at any point, and we will, including
            the copy in the inbox.
          </p>
          <h3 className="mt-6 font-medium">Please leave secrets out</h3>
          <p className="text-muted-foreground mt-2">
            Do not paste access tokens, API keys, passwords, or private source into the form. Redact
            them from logs first. If you need to send something sensitive, say so and we will
...
/** The two report kinds that need saying out loud: vulnerabilities and barriers. */
      ...
      <div className="mx-auto grid w-full max-w-6xl gap-10 md:grid-cols-3">
        ...
        <div className="text-sm leading-6 md:col-span-2">
          ...
          <p className="text-muted-foreground mt-2">
            ...
            rather than opening a public issue &mdash; the form is private, and an issue is not. We
            acknowledge security reports within {supportResponseDays} business days and will tell
            you when a fix ships.
          </p>
          <h3 className="mt-6 font-medium">Accessibility barriers</h3>
          <p className="text-muted-foreground mt-2">
            If anything in {appName}, Pragma Go, or this site is unusable with VoiceOver, TalkBack,
            a keyboard, or at your text size, report it the same way and mark it as an accessibility
            problem. We treat those as defects, not as feature requests.
          </p>
        </div>
      </div>
    </section>
