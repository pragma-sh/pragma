---
title: "@pragma/sdk"
description: A typed TypeScript client for a running Pragma host — sessions, agent events, fanouts, scratchpads, whiteboards, and the workspace.
---
