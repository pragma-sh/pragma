...
**Remove** it. In the browser, connections are kept in session storage unless you choose
**Remember this browser**, so closing the tab clears them. Settings → **Unpair this device** returns to the pairing screen straight
