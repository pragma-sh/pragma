...
const ACTION_LABELS: Record<KeybindingAction, string> = {
  ...
  switchToWorktree1: "Switch to worktree 1",
  switchToWorktree2: "Switch to worktree 2",
  switchToWorktree3: "Switch to worktree 3",
  switchToWorktree4: "Switch to worktree 4",
  switchToWorktree5: "Switch to worktree 5",
  switchToWorktree6: "Switch to worktree 6",
  switchToWorktree7: "Switch to worktree 7",
  switchToWorktree8: "Switch to worktree 8",
  switchToWorktree9: "Switch to worktree 9",
