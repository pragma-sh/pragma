...
pub use generated::{
    ...
    DiffSide, DirEntry, EditorLauncher, EditorLaunchers, FileChange, FileChangeKind, FileContents,
    FileDiff, Gateway, GitHub, GitHubAuthMethod, GitHubAuthStatus, GitHubRepoRef, GitHubUser,
    ...
    KeybindingsFiles, Links, NewWorktreeSpec, OpenPort, PairingPayload, PaletteSearchMatch,
    ...
    RunScriptSplit, RunScriptVerticalSplit, ScriptRunStatus, Scripts, SettingsScope,
    SplitHorizontal, SplitNode, SplitSplit, SplitTabLeaf, SplitVertical, Tab, TabKind, Tunnel,
    WindowDefaults, WorkspaceSnapshot, Worktree, WorktreeChanges, WorktreeCommit,
    WorktreeCommitList, WorktreeStatus,
};
