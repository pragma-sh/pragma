...
pub use generated::{
    ...
    AutomationsChangedPayload, BranchSyncStatus, CatalogAgent, ChangeStatus, ChangedFile,
    Constants, ControlMethod, Daemon, DefaultShells, DiffSide, DirEntry, EditorLauncher,
    EditorLaunchers, FileChange, FileChangeKind, FileContents, FileDiff, Gateway, GitHub,
    ...
    KeybindingChordModifiersItem, Keybindings, KeybindingsConfig, Links, NewWorktreeSpec, OpenPort,
