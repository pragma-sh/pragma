...
pub use generated::{
    ...
    DefaultShells, DiffSide, DirEntry, EditorLauncher, EditorLaunchers, FileChange, FileChangeKind,
    FileContents, FileDiff, Gateway, GitHub, GitHubAuthMethod, GitHubAuthStatus, GitHubRepoRef,
    ...
    TerminalBackend, Tunnel, WindowDefaults, WorkspaceSnapshot, Worktree, WorktreeChanges,
