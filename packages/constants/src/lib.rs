...
pub use generated::{
    ...
    Daemon, DefaultShells, DiffSide, DirEntry, EditorLauncher, EditorLaunchers, Fanout,
    ...
    Tunnel, WindowDefaults, WorkspaceSnapshot, Worktree, WorktreeChanges, WorktreeCommit,
