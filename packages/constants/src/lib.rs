...
pub use generated::{
    ...
    Constants, ControlMethod, Daemon, DiffSide, DirEntry, EditorLauncher, EditorLaunchers,
    FileChange, FileChangeKind, FileContents, FileDiff, Gateway, GitHub, GitHubAuthStatus,
    ...
    KeybindingsConfig, Links, NewWorktreeSpec, PairingPayload, PaletteSearchMatch,
