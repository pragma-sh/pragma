...
pub use generated::{
    ...
    AutomationsChangedPayload, Bench, BoardDraftCreatePayload, BranchSyncStatus, CatalogAgent,
    ChangeStatus, ChangedFile, Constants, ControlMethod, Daemon, DefaultShells, DiffSide, DirEntry,
    EditorLauncher, EditorLaunchers, Fanout, FanoutCreateRequest, FanoutDefaults,
    FanoutDeliveryReceipt, FanoutDeliveryState, FanoutExistingParent, FanoutExistingParentKind,
    FanoutFailure, FanoutFailureCode, FanoutFinalizeStage, FanoutMember, FanoutMemberRequest,
