...
pub use generated::{
    ...
    FileChangeKind, FileContents, FileDiff, Gateway, GitHub, GitHubAuthMethod, GitHubAuthStatus,
    ...
    KeybindingsConfig, KeybindingsFiles, Links, NewWorktreeSpec, OpenPort, PairingPayload,
    PaletteSearchMatch, PaletteSearchMatchKind, PaletteSearchResponse, Platform, PlatformChord,
    Project, ProjectIcon, ProjectScriptsConfig, Protocol, ProtocolErrorCode, ProtocolEventKind,
